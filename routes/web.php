...
*/
 ...
 Route::get('/accounts/action/{user_id}', ['uses' =>'BankController@updateAction','as' => 'bank.accounts.action']);
 ...
 Route::put('/account/{user_id}/edit', ['uses' =>'BankController@update','as' => 'bank.accounts.edit']);
